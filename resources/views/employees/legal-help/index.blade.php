...
<div class="bg-white min-h-screen overflow-x-hidden">
        ...
        <div class="max-w-6xl mx-auto px-6 py-14 grid md:grid-cols-2 gap-10 items-center">
            ...
            <div class="flex flex-col items-start text-left">
                ...
                <h1 class="text-4xl sm:text-5xl font-extrabold text-slate-900 leading-tight mb-4">
                    Legal Help &amp;<br>
                    <span class="text-blue-600">Workplace Support</span>
                </h1>

                <p class="text-slate-500 text-base mb-7 max-w-md">
                    Facing challenges at work? Connect with experienced professionals for legal
                    advice, workplace guidance, and confidential support to resolve
                ...
                <div class="flex items-center gap-3">
                    <a href="#messages-section"
                       ...
                       class="inline-flex items-center gap-1.5 rounded-lg bg-blue-600 text-white text-sm font-semibold px-5 py-2.5 hover:bg-blue-700 transition">
                        Get Legal Help
                    </a>
                    <a href="{{ route('employee.legal-help.create') }}"
                       class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white text-slate-700 text-sm font-semibold px-5 py-2.5 hover:border-blue-400 hover:text-blue-600 transition">
                        Talk to a Lawyer
                    </a>
                </div>
            </div>
            ...
            <div class="relative flex justify-center md:justify-end">
                <img
                    src="{{ asset('assets/img/legal.png') }}"
                    alt="Legal help"
                ...
                <div class="absolute top-6 left-0 md:left-4 flex items-center gap-2 bg-white rounded-xl shadow-lg shadow-blue-900/10 px-4 py-2.5">
                    <span class="w-8 h-8 rounded-lg bg-blue-100 flex items-center justify-center shrink-0">
                        <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2h9l3 3v17H6z"/><path d="M9 8h6M9 12h6M9 16h4"/></svg>
                    </span>
                    <span class="text-sm font-semibold text-slate-800 whitespace-nowrap">Case Files</span>
                </div>
                ...
                <div class="absolute bottom-6 left-0 md:-left-6 flex items-center gap-2 bg-white rounded-xl shadow-lg shadow-blue-900/10 px-4 py-2.5">
                    ...
                    <span class="text-sm font-semibold text-slate-800 whitespace-nowrap">Talk to a Lawyer</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:items-stretch">
            ...
            <div class="lg:col-span-1 flex flex-col rounded-xl border border-slate-200 bg-white shadow-sm p-6">
            ...
            <div id="messages-section" class="lg:col-span-1 flex flex-col self-start rounded-xl border border-blue-100 bg-blue-50 shadow-sm p-6">
            ...
            {{-- How it works + quick help sidebar --}}
            <div class="lg:col-span-1 space-y-6">
                <div class="card-hover relative overflow-hidden rounded-xl bg-gradient-to-br from-blue-600 to-blue-500 shadow-sm p-6 text-white">
                ...
                <div class="card-hover rounded-xl border border-slate-200 bg-white shadow-sm p-6">
