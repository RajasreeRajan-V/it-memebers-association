{{-- resources/views/employees/layout/navigation.blade.php --}}
    ...
    <nav class="sidebar-nav">
        ...
        {{-- <a href="#"
           >
            ...
            <span>Tasks</span>
            <span class="badge">{{ $pendingTasks ?? 5 }}</span>
        </a> --}}
        ...
        {{-- <a href="#"
           >
            ...
            <span>Projects</span>
            <span class="badge">{{ $activeProjects ?? 3 }}</span>
        </a> --}}
        ...
        {{-- <a href="#"
          >
            ...
            @if($pendingLeave ?? 0 > 0)
                <span class="badge">{{ $pendingLeave }}</span>
            @endif
        </a> --}}
...
<style>
    /* ===== SIDEBAR OVERRIDES (match employee theme) ===== */
    .sidebar {
        width: 260px;
        background: #1a1a2e;
        color: #fff;
