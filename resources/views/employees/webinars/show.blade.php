...
<div class="container" style="max-width:800px;padding:48px 0;">
    <a href="{{ route('employee.webinars') }}" style="font-size:0.85rem;color:var(--muted);">&larr; Back to Events</a>
    ...
    <div class="sidebar-card" style="padding:28px;margin-top:16px;">
        ...
        <div style="margin-top:24px;">
            @if(!$registration)
                <form method="POST" action="{{ route('employee.webinars.register', $webinar) }}">
                    @csrf
            ...
            @elseif($scheduledDate->lt(\Illuminate\Support\Carbon::today()))
                ...
                @if($registration->attendance_status === 'attended')
                    <a href="{{ route('employee.webinars.certificate', $webinar) }}" class="btn btn-primary" style="margin-top:10px;display:inline-block;">
                ...
                <div style="margin-top:24px;padding-top:20px;border-top:1px solid #e5e7eb;">
                    ...
                    <form method="POST" action="{{ route('employee.webinars.feedback', $webinar) }}" id="feedback-form"
