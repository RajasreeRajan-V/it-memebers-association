    ...
    <div class="material-card-stats">
        @if($isPast)
            ...
            @if($reg->attendance_status === 'attended')
                <a href="{{ route('employee.webinars.certificate', $webinar) }}" style="display:block;margin-top:4px;font-size:0.78rem;">
        ...
        <a href="{{ route('employee.webinars.show', $webinar) }}" class="btn btn-primary" style="margin-top:10px;padding:7px 18px;font-size:0.8rem;">
            View Details
        </a>
    </div>
</div>