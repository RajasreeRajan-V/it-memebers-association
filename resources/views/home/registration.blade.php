        ...
        <div class="hero-membership">
            <div class="membership-card">
                ...
                <div class="membership-actions">
                    <!-- UPDATED: Changed href to scroll to registration section -->
                ...
                <p class="membership-note">
                    <svg viewBox="0 0 24 24" width="14" height="14">
                        <path d="M12 2a10 10 0 1 0 10 10 10 10 0 0 0-10-10z" stroke="currentColor" stroke-width="2" fill="none"/>
                        <path d="M12 6v6l4 2" stroke="currentColor" stroke-width="2" fill="none"/>
                    </svg>
...
<!-- UPDATED: Added id="registration-section" -->
<section class="registration-section" id="registration-section">
    <div class="container">
        <div class="registration-wrapper-full">
            ...
            <form method="POST" action="{{ route('do_registration') }}" enctype="multipart/form-data" id="registerForm" novalidate>
                @csrf
                ...
                <div class="form-card" id="step2-section">
                    <div class="card-header">
                        ...
                        <div>
                            <h3>Are you a?</h3>
                            <p>Select the role that best describes you. This will customize your registration experience.</p>
                        </div>
                    </div>
                ...
                <div class="form-card" id="step3-section">
                    <div class="card-header">
                        <div class="card-icon" id="roleDetailIcon" style="background: linear-gradient(135deg, #4A90D9, #357ABD);">
                            <svg viewBox="0 0 24 24" width="24" height="24">
                        ...
                        <div>
                            ...
                            <p id="roleDescription">Provide your educational details to get started with internships and learning opportunities.</p>
                        </div>
                    </div>
...
<template id="tpl-student">
    <div class="form-group">
        ...
        <input type="text" name="college_name" value="{{ old('college_name') }}" required placeholder="Enter college name">
    </div>
    <div class="form-group">
        <label class="form-label"><span>University</span><span class="required">*</span></label>
        <input type="text" name="university" value="{{ old('university') }}" required placeholder="Enter university">
    </div>
    <div class="form-group">
    ...
    <div class="form-group full-width">
        ...
        <input type="text" name="interested_domain" value="{{ old('interested_domain') }}" placeholder="e.g. Web Development">
    </div>
    <div class="form-group">
...
<template id="tpl-employee">
    <div class="form-group">
        ...
        <input type="text" name="company_name" value="{{ old('company_name') }}" required placeholder="Current company name">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Designation</span><span class="required">*</span></label>
        <input type="text" name="designation" value="{{ old('designation') }}" required placeholder="Your job title">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Years of Experience</span><span class="required">*</span></label>
        <input type="number" name="experience_years" value="{{ old('experience_years') }}" min="0" required placeholder="e.g. 5">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Current CTC (LPA)</span></label>
        <input type="number" name="current_ctc" value="{{ old('current_ctc') }}" step="0.01" min="0" placeholder="e.g. 5.5">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Expected CTC (LPA)</span></label>
        <input type="number" name="expected_ctc" value="{{ old('expected_ctc') }}" step="0.01" min="0" placeholder="e.g. 8.0">
    </div>
    <div class="form-group">
...
<template id="tpl-freelancer">
    <div class="form-group">
        ...
        <input type="text" name="specialization" value="{{ old('specialization') }}" required placeholder="e.g. UI/UX Design">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Years of Experience</span><span class="required">*</span></label>
        <input type="number" name="experience" value="{{ old('experience') }}" min="0" required placeholder="e.g. 3">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Hourly Rate (₹)</span></label>
        <input type="number" name="hourly_rate" value="{{ old('hourly_rate') }}" step="0.01" min="0" placeholder="e.g. 500">
    </div>
    <div class="form-group">
        ...
        <select name="availability">
            ...
            <option value="Not available" {{ old('availability') == 'Not available' ? 'selected' : '' }}>Not available right now</option>
        </select>
    </div>
    <div class="form-group">
...
<template id="tpl-investor">
    <div class="form-group">
        ...
        <input type="text" name="organization" value="{{ old('organization') }}" required placeholder="Fund, firm, or 'Individual'">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <select name="investment_range" required>
            <option value="">Select range</option>
            <option value="Under ₹5L" {{ old('investment_range') == 'Under ₹5L' ? 'selected' : '' }}>Under ₹5L</option>
            <option value="₹5L - ₹25L" {{ old('investment_range') == '₹5L - ₹25L' ? 'selected' : '' }}>₹5L – ₹25L</option>
            <option value="₹25L - ₹1Cr" {{ old('investment_range') == '₹25L - ₹1Cr' ? 'selected' : '' }}>₹25L – ₹1Cr</option>
            <option value="₹1Cr - ₹5Cr" {{ old('investment_range') == '₹1Cr - ₹5Cr' ? 'selected' : '' }}>₹1Cr – ₹5Cr</option>
    ...
    <div class="form-group">
        ...
        <input type="text" name="preferred_sectors" value="{{ old('preferred_sectors') }}" required placeholder="e.g. Fintech, HealthTech">
    </div>
    <div class="form-group">
        <label class="form-label"><span>LinkedIn Profile</span></label>
        <input type="url" name="linkedin" value="{{ old('linkedin') }}" placeholder="https://linkedin.com/in/...">
...
<template id="tpl-mentor">
    <div class="form-group">
        ...
        <input type="text" name="company" value="{{ old('company') }}" required placeholder="Current or most recent company">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Designation</span><span class="required">*</span></label>
        <input type="text" name="designation" value="{{ old('designation') }}" required placeholder="Your job title">
    ...
    <div class="form-group">
        ...
        <input type="text" name="expertise" value="{{ old('expertise') }}" required placeholder="e.g. Product Management">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Years of Experience</span><span class="required">*</span></label>
        <input type="number" name="years_of_experience" value="{{ old('years_of_experience') }}" min="0" required placeholder="e.g. 10">
    </div>
    <div class="form-group">
        <label class="form-label"><span>Availability</span></label>
        <select name="availability">
...
<style>
    ...
    .registration-section {
        ...
        scroll-margin-top: 20px; /* Optional: adds space when scrolling to the section */
    }
