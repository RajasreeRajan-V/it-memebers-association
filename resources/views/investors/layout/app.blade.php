{{-- resources/views/investors/layout/app.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        * {
        ...
        /* ===== ADMIN WRAPPER (investor version) ===== */
        .admin-wrapper {
            display: flex;
            min-height: 100vh;
        }
...
<body>
    ...
    <div class="admin-wrapper">
        ...
        {{-- Sidebar / Navigation --}}
        @include('investors.layout.navigation')
            ...
            <header class="topbar">
                <div class="left-section">
                    ...
                    <div class="page-title">
                        ...
                        <small>@yield('page-subtitle', 'Investor overview')</small>
                    </div>
                ...
                <div class="user-menu">
                    ...
                    <div>
                        <div class="user-name">{{ auth()->user()->name ?? 'Investor' }}</div>
                        <div class="user-role">{{ auth()->user()->role ?? 'Investor' }}</div>
                    </div>
                    <div class="avatar">
