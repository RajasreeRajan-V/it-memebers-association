...
<div class="sp-grid">
    ...
    <div class="sp-form-group">
        ...
        <input type="text" id="startup_name" name="startup_name" value="{{ old('startup_name', $profile->startup_name ?? '') }}">
        @error('startup_name') <span class="sp-error">{{ $message }}</span> @enderror
    </div>

    <div class="sp-form-group">
        <label>Founder Name *</label>
        <input type="text" id="founder_name" name="founder_name" value="{{ old('founder_name', $profile->founder_name ?? '') }}">
    ...
    <div class="sp-form-group">
        ...
        <input type="tel" id="phone_number" name="phone_number" value="{{ old('phone_number', $profile->phone_number ?? '') }}">
        @error('phone_number') <span class="sp-error">{{ $message }}</span> @enderror
    </div>

    <div class="sp-form-group">
        <label>Industry</label>
        <input type="text" id="industry" name="industry" value="{{ old('industry', $profile->industry ?? '') }}">
        @error('industry') <span class="sp-error">{{ $message }}</span> @enderror
    </div>

    <div class="sp-form-group">
        <label>Team Size</label>
        <input type="text" id="team_size" name="team_size" value="{{ old('team_size', $profile->team_size ?? '') }}" placeholder="e.g. 1-10">
    ...
    <div class="sp-form-group">
        ...
        <input type="text" id="funding_required" name="funding_required" value="{{ old('funding_required', $profile->funding_required ?? '') }}" placeholder="e.g. $50,000">
    ...
    <div class="sp-form-group sp-field-full">
        ...
        <textarea id="business_description" name="business_description">{{ old('business_description', $profile->business_description ?? '') }}</textarea>
