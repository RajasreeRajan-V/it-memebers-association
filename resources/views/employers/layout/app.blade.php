{{-- resources/views/employer/layout/app.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        * {
        ...
        /* ===== ADMIN WRAPPER (employer version) ===== */
        .admin-wrapper {
            display: flex;
            min-height: 100vh;
        }
...
<body>
    ...
    <div class="admin-wrapper">
        ...
        {{-- Sidebar / Navigation --}}
        @include('employers.layout.navigation')
            ...
            <header class="topbar">
                <div class="left-section">
                    ...
                    <div class="page-title">
                        ...
                        <small>@yield('page-subtitle', 'Employer overview')</small>
                    </div>
                ...
                <div class="user-menu">
                    ...
                    <div>
                        <div class="user-name">{{ auth()->user()->name ?? 'Employer' }}</div>
                        <div class="user-role">{{ auth()->user()->role ?? 'Employer' }}</div>
                    </div>
                    <div class="avatar">
