<style>
    .internship-form-container { max-width: 700px; margin: 0 auto; padding: 15px 0 40px; }
    ...
    .form-card-header { background: linear-gradient(135deg, #0F172A 0%, #764ba2 100%); padding: 18px 25px; color: white; position: relative; overflow: hidden; }
    .form-card-header::before { content: ''; position: absolute; top: -50%; right: -20%; width: 200px; height: 200px; background: rgba(255,255,255,0.05); border-radius: 50%; pointer-events: none; }
    ...
    .form-control-custom:focus { border-color: #667eea; background: #ffffff; box-shadow: 0 0 0 3px rgba(102,126,234,0.1); outline: none; }
    ...
    textarea.form-control-custom { resize: vertical; min-height: 80px; font-size: 13px; }
    ...
    .btn-primary-custom { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; flex: 1; justify-content: center; }
    .btn-primary-custom:hover { transform: translateY(-1px); box-shadow: 0 4px 15px rgba(102,126,234,0.35); color: white; }
    ...
    .form-label-icon i { color: #667eea; font-size: 13px; width: 16px; }
    @media (max-width: 768px) {
        ...
        .internship-form-container { padding: 10px; }
    }
</style>
