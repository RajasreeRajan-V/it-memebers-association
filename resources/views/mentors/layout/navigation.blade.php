{{-- resources/views/mentors/layout/navigation.blade.php --}}
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        {{-- <a href="{{ route('mentor.mentees.index') }}"
           class="nav-item {{ request()->routeIs('mentor.mentees.*') ? 'active' : '' }}">
            <i class="fa-solid fa-users"></i>
            <span>Mentees</span>
            <span class="badge">{{ $totalMentees ?? 12 }}</span>
        </a> --}}
        ...
        {{-- <a href="{{ route('mentor.sessions.index') }}"
           class="nav-item {{ request()->routeIs('mentor.sessions.*') ? 'active' : '' }}">
            ...
            <span>Sessions</span>
            <span class="badge">{{ $upcomingSessions ?? 5 }}</span>
        </a> --}}

        {{-- <a href="{{ route('mentor.messages.index') }}"
           class="nav-item {{ request()->routeIs('mentor.messages.*') ? 'active' : '' }}">
        ...
        <div class="nav-label">Mentorship</div>

        {{-- <a href="{{ route('mentor.programs.index') }}"
           class="nav-item {{ request()->routeIs('mentor.programs.*') ? 'active' : '' }}">
            <i class="fa-solid fa-graduation-cap"></i>
            <span>Programs</span>
            <span class="badge">{{ $activePrograms ?? 3 }}</span>
        </a> --}}

        {{-- <a href="{{ route('mentor.goals.index') }}"
           class="nav-item {{ request()->routeIs('mentor.goals.*') ? 'active' : '' }}">
            <i class="fa-solid fa-bullseye"></i>
            <span>Goals & Progress</span>
        </a> --}}

        {{-- <a href="{{ route('mentor.resources.index') }}"
           class="nav-item {{ request()->routeIs('mentor.resources.*') ? 'active' : '' }}">
            <i class="fa-solid fa-folder-open"></i>
            <span>Resources</span>
        </a> --}}

        {{-- <a href="{{ route('mentor.feedback.index') }}"
           class="nav-item {{ request()->routeIs('mentor.feedback.*') ? 'active' : '' }}">
        ...
        {{-- <a href="{{ route('mentor.availability.index') }}"
           class="nav-item {{ request()->routeIs('mentor.availability.*') ? 'active' : '' }}">
            <i class="fa-solid fa-clock"></i>
            <span>Availability</span>
        </a> --}}

        {{-- <a href="{{ route('mentor.calendar.index') }}"
           class="nav-item {{ request()->routeIs('mentor.calendar.*') ? 'active' : '' }}">
        ...
        {{-- <a href="{{ route('mentor.profile.edit') }}"
           class="nav-item {{ request()->routeIs('mentor.profile.*') ? 'active' : '' }}">
            <i class="fa-solid fa-user"></i>
            <span>Profile</span>
        </a> --}}

        {{-- <a href="{{ route('mentor.settings.index') }}"
           class="nav-item {{ request()->routeIs('mentor.settings.*') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        ...
        <div class="copy">
            &copy; {{ date('Y') }} MentorHub
        </div>
    </div>
</aside>

<style>
    /* ===== SIDEBAR OVERRIDES (mentor theme - purple/indigo) ===== */
    .sidebar {
        width: 260px;
        background: #1a1a2e;
        color: #fff;
