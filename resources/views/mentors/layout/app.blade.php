{{-- resources/views/mentors/layout/app.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="admin-wrapper">
        ...
        {{-- Sidebar / Navigation --}}
        @include('mentors.layout.navigation')
            ...
            <header class="topbar">
                <div class="left-section">
                    ...
                    <div class="page-title">
                        ...
                        <small>@yield('page-subtitle', 'Mentor overview')</small>
                    </div>
                ...
                <div class="user-menu">
                    ...
                    <div>
                        <div class="user-name">{{ auth()->user()->name ?? 'Mentor' }}</div>
                        <div class="user-role">{{ auth()->user()->role ?? 'Mentor' }}</div>
                    </div>
                    <div class="avatar">
