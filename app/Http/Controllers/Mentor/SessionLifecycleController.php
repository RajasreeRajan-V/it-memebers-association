...
class SessionLifecycleController extends Controller
{
    /*
    |--------------------------------------------------------------------------
    | Conduct Session — "Join Meeting / Session" -> in_progress
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Submit Session Notes — summary, discussion points, homework, resources
    |--------------------------------------------------------------------------
    */
    public function storeNotes(Request $request, MentorshipSession $session)
    {
        ...
        $data = $request->validate([
            'mentor_notes' => ['required', 'string', 'max:5000'],
    ...
    /*
    |--------------------------------------------------------------------------
    | Complete Session — status -> completed, student notified
    |--------------------------------------------------------------------------
    */
    public function markCompleted(MentorshipSession $session)
    {
        ...
        abort_unless(
            in_array($session->status, ['scheduled', 'confirmed', 'in_progress']),
            422,
        ...
        // TODO: email the student their session summary, homework and resources.
