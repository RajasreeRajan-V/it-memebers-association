...
{
    /**
     * Employer articles hub — same layout/behaviour as the employee hub,
     * but read-only (no "New Article" button) and ALWAYS scoped to
     * approved() articles. Employers can browse, like, and comment.
     */
    public function index(Request $request)
    {
        ...
        $query = Article::query()
            ...
            ->approved(); // employers only ever see approved articles
        ...
        match ($tab) {
            ...
            'most-commented' => $query->orderByDesc('comments_count'),
    ...
    [
        ...
        return view('employers.articles.index', [
            'articles'         => $articles,
     ...
     * Always returns JSON. Only ever serves approved articles.
     */
